...
```
java -Dspring.profiles.active=production -jar ./target/bibliotecatinaut-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/bibliotecatinaut
```
